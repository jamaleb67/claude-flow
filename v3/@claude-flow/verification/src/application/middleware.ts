...
// Stub types for middleware - using 'any' for Day 1 compatibility
// These will be properly typed when integrated with domain types
type VerificationRequest = any;
type VerificationResult = any;
type SecurityMiddleware = any;
type SecurityAlert = any;
type ThreatLevel = any;
type AttackPattern = any;
...
// All classes are already exported with 'export class' declarations